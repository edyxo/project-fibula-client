...
Services = {
    ...
    clientAssets = {
        enabled = false, -- Fibula 7.72: usamos data/things/772 (Tibia.dat/spr), no bajar assets modernos
...
if ENABLE_SERVERS then
    ...
    Servers_init = {
        ...
        -- Project Fibula - mismo server que Tibia-Eddie7.exe (world.fibula.app:7171, proto 772)
        -- Unica entrada => entergame la auto-selecciona (plug and play)
        ["world.fibula.app"] = {
            port = 7171,
            protocol = 772,
            httpLogin = false
